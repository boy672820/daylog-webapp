          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <div className='text-sm text-muted-foreground'>
              ...
              <ul className='space-y-2'>
                ...
                <li>
                  <a
                    href='https://github.com/boy672820/review-note-webapp/issues'
                    target='_blank'
                    rel='noreferrer'
                    className='hover:text-primary hover:underline'
                  >
            ...
            <div className='text-sm text-muted-foreground'>
              ...
              <ul className='space-y-2'>
                <li>
                  <a
                    href='mailto:contact@day-log.co.kr'
                    className='hover:text-primary hover:underline'
                  >
                    contact@daylog.app
                  </a>
                ...
                <li>
                  <a
                    href='https://github.com/boy672820/review-note-webapp/stargazers'
                    target='_blank'
                    rel='noreferrer'
