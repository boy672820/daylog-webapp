...
<head>
    ...
    <title>데이로그(Daylog) 이메일 인증을 완료해주세요.</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            <h1 class="email-title">인증 코드 안내</h1>
            <p class="email-message">데이로그에서 인증 요청이 접수되었습니다. 아래 인증 코드를 입력하여 인증을 완료해 주세요.</p>
            <div class="verification-code">{####}</div>
            <p class="email-message">이 코드는 10분 동안 유효하며, 본인이 요청하지 않았다면 이 이메일을 무시하셔도 됩니다.</p>
        </div>
        <div class="email-footer">
            <p>&copy; 2025 데이로그(Daylog). All rights reserved.</p>
            <p>이 메일은 이메일 인증 과정에서 자동으로 발송되었습니다.</p>
        </div>
    </div>
</body>
</html>
